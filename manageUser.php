<?php
    ...
    if(!$u->hasPrivilege("addUser")||!$u->hasPrivilege("editUser")||!$u->hasPrivilege("deleteUser"))
    {
...
<form action="/manageUser_action.php" onsubmit = "return validation()" method="post">
    ...
    <form action="/rolemanagement_action.php" method="post">
        <table id="Table1">
            ...
            <?php
                ...
                $sql = "select users.id, users.email, users.tel, users.addr from users inner join user_role on users.id = user_role.id where user_role.role_id = 7";
            ...
            function GetSelected() {
                ...
                while(i<checkBoxes.length){
                    ...
                    if(checkBoxes[i].checked){
                        ...
                        xmlhttp.open("GET", "deleteUser.php?q="+message, true);
                        xmlhttp.send();
                    }
                    i++;
                }
